...
export function ChartAreaInteractive() {
  ...
  const filteredData = chartData.filter((item) => {
    ...
    const startDate = referenceDate - daysToSubtract * 24 * 60 * 60 * 1000
  ...
  return (
    <Card className="@container/card border-white/15 bg-[rgba(22,27,29,0.62)] shadow-[0_8px_24px_rgba(0,0,0,0.28)] backdrop-blur-md">
      <CardHeader>
        <CardTitle>Прогноз динамики нагрузки</CardTitle>
        <CardDescription>
          <span className="hidden @[540px]/card:block">
            Сравнение прогноза и исторической нормы
          </span>
          <span className="@[540px]/card:hidden">Прогноз и норма</span>
        </CardDescription>
        <CardAction>
          <ToggleGroup
            type="single"
