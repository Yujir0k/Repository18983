...
Место для скриншота процесса инференса:
<img width="661" height="760" alt="Снимок экрана 2026-04-08 215950" src="https://github.com/user-attachments/assets/614babf9-afa9-4950-8370-342a9ec68aed" />
...
### 3.3 Места для скриншотов Центра управления
...
### 4.7 Места для скриншотов аналитики
...
Место для схемы:
- `[PLACEHOLDER] docs/images/ml/01-full-ml-architecture.png`
...
|---|---|---|
| Model A (финальная) | Основной production-прогноз | `TODO` |
| Model B | Альтернативная модель | `TODO` |
| Model C | Альтернативная модель | `TODO` |
...
README построен в последовательности «бизнес -> продукт -> оператор -> аналитика -> ML -> метрики -> развитие -> запуск». Это упрощает оценку решения с точки зрения практической пользы для логистики.
